...
@st.cache_data
def load_data():
    # Load the pre-processed dataset that includes all engineered features
    # (Age, TotalSpend, Segment, Priority_Tier, HighValue, AtRisk, etc.)
    df = pd.read_csv("dataset/marketing_cleaned.csv")
    return df
